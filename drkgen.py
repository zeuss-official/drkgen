...
def options():
  ...
  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝     ╚═════╝ ╚══════╝╚═╝  ╚═══╝                        
                                                                          """))
    print(f'''{Fore.LIGHTWHITE_EX}                    [ Made by {Fore.YELLOW}zeuss#1602 {Fore.LIGHTWHITE_EX}]
  {Fore.LIGHTWHITE_EX}
  ''')
    print("""
    [1] Generators
...
def amazon():
    ...
    ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝ ╚═════╝ ╚═╝  ╚═══╝     ╚═════╝ ╚══════╝╚═╝  ╚═══╝                                                                   
    """))
    print(f"""{Fore.LIGHTWHITE_EX}     [ Made by {Fore.YELLOW}zeuss#1602 {Fore.LIGHTWHITE_EX}]{Fore.GREEN} DRK GENERATOR PROJECT
  {Fore.LIGHTWHITE_EX}
  """)
